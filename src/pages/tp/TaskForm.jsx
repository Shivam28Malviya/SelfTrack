  ...
  return (
    <TpLayout title={editing ? 'Edit task' : 'New task'}>
      <section className="tp-panel">
        <Link to={editing ? `/tp/tasks/${id}` : '/tp/delivery'} className="text-sm hover:opacity-70">← Back</Link>
      ...
      <form className="tp-card flex flex-col gap-6" onSubmit={submit} noValidate>
        ...
        <div className="flex flex-wrap gap-3 justify-end">
          <Link to={editing ? `/tp/tasks/${id}` : '/tp/delivery'} className="tp-btn-ghost">Cancel</Link>
