      ...
      <section className="tp-panel flex flex-col gap-5">
        <div className="flex flex-wrap items-end justify-between gap-4">
          ...
          <div className="flex gap-3">
            {canEdit && <Link to="/tp/entry" className="tp-btn">Quick log</Link>}
            {canEdit && <Link to="/tp/audit" className="tp-btn-ghost">Audit trail</Link>}
          </div>
        </div>
                ...
                return (
                  <tr key={key}>
                    ...
                    <td className="border-t px-3 py-3 text-sm" style={{ borderColor: 'var(--tp-line)' }}>
                      <Link to={`/tp/people/${entry.personId}`}>{entry.personName}</Link>
                    </td>
                    <td className="border-t px-3 py-3 text-sm" style={{ borderColor: 'var(--tp-line)' }}>
